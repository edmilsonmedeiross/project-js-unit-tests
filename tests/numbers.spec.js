...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  /* it('Verifica se a função `numbers` retorna `true` quando o array contém apenas números e falso caso contrário', () => {
    ...
    it('if all numbers return true', () => {
      expect([1, 2, 3, 4, 5]).toBeTruthy;
    });
    it('if one of numbers to string return false', () => {
      expect([1, 2, '3', 4, 5]).toBeFalsy;
    });
    it('if one of numbers to text return false', () => {
      expect([1, 'a', 3]).toBeFalsy;
    });
    it('if one of numbers to empty return false', () => {
      expect([' ']).toBeFalsy;
    });
